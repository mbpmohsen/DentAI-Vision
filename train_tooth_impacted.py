...
def train_model():
    ...
    # Train the model
    model.train(
        data='./Impacted_teeth_dataset/data.yaml',  # Path to your data.yml file
        epochs=50,                # Number of training epochs
        imgsz=640,                # Image size
        batch=8                   # Batch size
    )
    print("Training completed. Model is saved in the 'runs/impacted' directory.")


# Step 2: Test the Model
def test_model(image_path, model_path='runs/detect/impacted/train/weights/best.pt'):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', type=str, default='runs/detect/impacted/train/weights/best.pt', help="Path to the trained model weights.")
