...
train_periodontal_app = FastAPI()

# Function to load the model
def load_model(model_path='/Users/mohsen/Projects/my_tooth_counter/runs/detect/train15/weights/best.pt'):
    try:
...
@train_periodontal_app.post("/predict/")
